...
namespace {
    void ThrowException(JNIEnv *env, OgaResult *result) {
        ...
        static const char *className = "com/example/basiscodelab/phi/GenAIException";
...
Java_com_example_basiscodelab_phi_GenAIWrapper_loadModel(JNIEnv *env, jobject thiz, jstring model_path) {
...
Java_com_example_basiscodelab_phi_GenAIWrapper_releaseModel(JNIEnv *env, jobject thiz, jlong native_model) {
    auto* model = reinterpret_cast<OgaModel*>(native_model);
    OgaDestroyModel(model);
}

extern "C" JNIEXPORT jlong JNICALL
Java_com_example_basiscodelab_phi_GenAIWrapper_createTokenizer(JNIEnv *env, jobject thiz, jlong native_model) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_example_basiscodelab_phi_GenAIWrapper_releaseTokenizer(JNIEnv *env, jobject thiz, jlong native_tokenizer) {
...
Java_com_example_basiscodelab_phi_GenAIWrapper_run(JNIEnv *env, jobject thiz, jlong native_model, jlong native_tokenizer,
